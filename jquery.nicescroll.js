...
// console.log('init.hw', this.ishwscroll);
...
// console.log('getScrollTop');
        ...
        /* m */
        var y = self.doc.translate.y;// + self.doc.data('shiftUp') || 0;
        // console.log('getScrollTop:', y);
        return y;
        /* --m */
...
// console.log('setScrollTop.hw3d', val);
        ...
        this.setScrollTop = function(val,silent) {
// console.log('setScrollTop.translate', val);
          self.doc.translate.y = val;
          self.doc.translate.ty = (val*-1)+"px";
...
/* m */
console.log('setScrollTop.native', val);
        var top = self.doc.data('top') || 0;
// console.log('top', top);
        if (top + val > 0) {
          val = val + top;
          top = 0;
        ...
        var topAvailable = self.win.data('shiftUp') || 0;
        if (top < topAvailable) top = topAvailable;

console.log('-> setScrollTop.native', top, val, topAvailable);
...
console.log('onmousewheel', self.locked);
...
console.log('doScrollPos.native');
...
// console.log('doScrollPos.hw',x,y);
        var py = self.getScrollTop();
        var px = self.getScrollLeft();
...
console.log('doScrollPos.smooth', x, y);
...
console.log('doScrollBy', stp, relative, self.bouncescroll);
      var ny = 0;
      if (relative) {
